...
class WritePassword : public Handler<T, ClassConnection, ClassDBMethods, ClassDBWorker> {
 public:
...
template<typename T,
        ...
        class ClassDBMethods = DBMethods<T, ClassConnection>,
        class ClassDBWorker = DBWorker<T, ClassConnection, ClassDBMethods>>
class WriteNickname : public Handler<T, ClassConnection, ClassDBMethods, ClassDBWorker> {
 public:
    Context operator()(const Context &request_body, ClassDBWorker *db_worker) const override;
};
